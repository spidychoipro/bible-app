...
7개 번역을 지원하는 PWA 성경 앱. 오프라인 읽기, 개인 기록, 말씀카드 생성.

## 기능

**📖 읽기** — 구약 39권 + 신약 27권, 7개 번역 지원
- 개역한글 / 개역개정 / 새번역 / 새한글 / The Message / NASB2020 / NIV2011
- 장 넘김 페이드 애니메이션
- 좌우 스와이프로 장 이동
- 키보드 방향키 탐색
- 읽기 위치 자동 저장
...
- Bible JSON: `data/bible-{id}.json` (7개 번역)
